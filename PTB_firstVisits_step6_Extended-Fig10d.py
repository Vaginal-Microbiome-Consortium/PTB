...
dfALL=pickle.load( open( 'data-sets-manuscript/externalCohort_Fig10d_UAB_16S_MV1D_STIRRUPSmypctV2.pickle', "rb" ) );
...
f.savefig('paperFigs/Extended-Fig10d.pdf',dpi=600,bbox_inches='tight')#,pad_inches=.05)
