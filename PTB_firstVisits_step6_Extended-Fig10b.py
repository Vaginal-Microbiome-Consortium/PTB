...
dfALL=pickle.load( open( 'data-sets-manuscript/externalCohort_Fig10b_WashU_16S_MV1D_STIRRUPSmypctV2.pickle', "rb" ) );

dfI_class=dfALL[['Class']].copy();
dfI_x=dfALL.drop(columns=['Class'],inplace=False).copy();



(df_data,df_class)=PandasUtils.innerNonJoin((dfI_x.copy(),dfI_class.copy()));


y_data=df_class.as_matrix().astype(dtype='float32').flatten();

colNames=[ 'MV1D-Sneathia amnii','MV1D-Lachnospiraceae BVAB1','MV1D-TM7 OTU-H1','MV1D-Prevotella cluster2',
            'MV1D-Aerococcus christensenii',
 'MV1D-Clostridiales BVAB2',
 'MV1D-Coriobacteriaceae OTU27',
 'MV1D-Dialister cluster51',
 'MV1D-Dialister micraerophilus',
 'MV1D-Megasphaera OTU70_type1',
 'MV1D-Parvimonas OTU142',
 'MV1D-Prevotella amnii',
 'MV1D-Sneathia sanguinegens',
 'MV1D-Lactobacillus crispatus_cluster',
 'MV1D-Lactobacillus iners',
 'MV1D-Gardnerella vaginalis'
 ];
df_xx=df_data[colNames];
...
f.savefig('paperFigs/Extended-Fig10b.pdf',dpi=600,bbox_inches='tight')#,pad_inches=.05)
