...
# wmgs read Counts
wmgsreads <- read_delim("~/Documents/ptb47-extID/data/ptb47.wmgs.readCounts.extID.txt", delim="\t")
# wmgs path abundances
wmgspath <- read_delim("~/Documents/ptb47-extID/data/ptb47.wmgs.humann2-pathAbundance.extID.txt", delim = "\t") %>%
  filter(!(Pathway %in%  c("UNMAPPED", "UNINTEGRATED"))) 
  

# wmts read Counts
# wmtsreads 
wmtsreads <- read_delim("~/Documents/ptb47-extID/data/ptb47.wmts.readCounts.extID.txt", delim="\t")
# wmts path abundances
wmtspath <- read_delim("~/Documents/ptb47-extID/data/ptb47.wmts.humann2-pathAbundance.extID.txt", delim = "\t") %>%
  filter(!(Pathway %in%  c("UNMAPPED", "UNINTEGRATED"))) %>%
...
```{r}
#ExtDataFig8A <- plot_grid(sb, tlegend, nrow = 2, rel_heights = c(1,0.5))
#ExtDataFig8A
ggsave("~/Documents/ptb47-extID/revision-0314/figures-eps/ExtDataFigure8a_16S.eps", sb, units = "in", width = 10, height = 3, dpi=600)
ggsave("~/Documents/ptb47-extID/revision-0314/figures-eps/ExtDataFigure8a_16Slegend.eps", tlegend, units = "in", width = 10, height = 1.5, dpi=600)
```
...
#cols <- get_palette(palette = "ucscgb", 12)
...
```
```{r}
ggsave("~/Documents/ptb47-extID/revision-0314/figures-eps/ExtDataFigure8b_WMGS.eps", wmgs_somepath, width = 10, height = 3, units = "in", dpi=600)
ggsave("~/Documents/ptb47-extID/revision-0314/figures-eps/ExtDataFigure8b_WMTS.eps", wmts_somepath, width = 10, height = 3, units = "in", dpi=600)
ggsave("~/Documents/ptb47-extID/revision-0314/figures-eps/ExtDataFigure8b_legend.eps", plegend, width = 12, height = 2, units = "in", dpi=600)


#ExtDataFig8B <- plot_grid(wmgs_somepath, wmts_somepath, plegend, nrow = 3, rel_heights = c(1,1,0.5))
#ExtDataFig8B
```
...
#### ExtData Figure 8
```{r}
#ExtDataFig8 <- plot_grid(ExtDataFig8A, NULL, ExtDataFig8B, nrow = 3, rel_heights = c(1.5,0.2,2.5), labels = c("a", "", "b"), label_size = 20)
#ggsave("~/Documents/ptb47-extID/revision-0314/figures/ExtDataFigure8.jpeg", ExtDataFig8,
#       units = "in", width = 12, height = 12, dpi = 600)
```
